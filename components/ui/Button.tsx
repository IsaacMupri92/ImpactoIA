...
const variantStyles = {
  primary:
    'bg-sustainable-600 text-white hover:bg-sustainable-700 focus:ring-sustainable-500 border-transparent',
  secondary:
    'bg-white text-gray-700 hover:bg-gray-50 focus:ring-gray-500 border-gray-300',
  danger:
    'bg-impact-600 text-white hover:bg-impact-700 focus:ring-impact-500 border-transparent',
  ghost:
